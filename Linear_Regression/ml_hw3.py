...
if __name__ == '__main__':
    ...
    from ml_hw1 import Kmean
    from ml_hw2 import PCA
    ...
    X_all_train = np.concatenate((np.zeros((X_train.shape[0],1)), X_train_kmeans, X_pca_train, X_train), axis=1)
    X_all_test = np.concatenate((np.zeros((X_test.shape[0],1)), X_test_kmeans, X_pca_test, X_test), axis=1)
